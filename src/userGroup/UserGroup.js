...
import {ClearObservationPage,FetchGroupObservations} from '../actions/index';
...
export default connect(mapStateToProps, {FetchUserGroupName,ClearObservationPage,FetchGroupObservations})(UserGroup);
