...
import ShowGallery from '../components/imageGallery/image_display';
...
class ObservationListView extends Component {
...
export default  withRouter(connect(mapStateToProps)(ObservationListView));
